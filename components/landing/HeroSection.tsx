...
export default function HeroSection() {
  ...
  if (!mounted) return <div className="py-16 min-h-[600px]" />;

  return (
    <div className="relative grid lg:grid-cols-2 gap-12 items-center py-16">
      <div className="text-left z-10">
        ...
        <p className="text-lg md:text-xl text-gray-400 max-w-lg mb-8">
          Join 50,000+ traders maximizing profits with automated rebates. Near-zero cost trading is finally here.
        </p>

        <div className="flex flex-wrap gap-4 mb-12">
          <Link
            href="/signup"
            className="px-8 py-4 bg-gradient-to-r from-design-pink to-design-purple text-white rounded-xl font-bold hover:scale-105 active:scale-95 transition-all shadow-lg shadow-design-pink/20"
          >
            Start Saving Now
          </Link>
      ...
      <div className="relative group hidden lg:block">
        ...
        <div className="relative aspect-[4/5] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
          ...
          {/* Mobile web preview - Bright Idol Style */}
          <motion.div
